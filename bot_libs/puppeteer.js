 ...
 */
const getGeneratedImageData = async (url, outputSelector, metaDataSelector, captionSelector) => {
 ...
 * @returns {Promise<Object>}
 */
const generateEmojiScene = async (url, outputLinkSelector, metaDataSelector, captionSelector) => {
  return getGeneratedImageData(url, outputLinkSelector, metaDataSelector, captionSelector)
}
